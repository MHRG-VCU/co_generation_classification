...
As can be seen, the architecture is basically an ensemble of _C_ LSTM networks,  _Net={N<sub>c</sub>  |  c ∈ C}_,  where _C_ is the set of classes. Each one of the networks _N<sub>c</sub>_ serves as a sequence model for the corresponding class _c_. 
